...
const Skills = () => {
  ...
  return (
                ...
                <div key={i} className="swiper_item">
                  <SwiperSlide>
                    ...
                    <div className="swipertext">
                      <div className="swiperTitle"> {item.image.title}</div>
                      <div className="subText">
                        {item.image.text.slice(0, 40) + '...'}
                      </div>
                      <div
                  ...
                  <SwiperSlide>
                    <div className="infoBarItem skillItem">
                      ...
                      <div
                        ...
                        onClick={() => changeBoxFalse(item.image.id)}
                      >
    ...
    //                 <ul className="carousel__slide-list">
    //                   {items2.map((pos, i) => {
    //                     const item = createItem2(pos, i, activeIdx);
    //                     return (
    //                       <li
    //                         className="carousel__slide-item"
    //                         style={item.styles}
